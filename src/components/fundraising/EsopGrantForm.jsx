                    ...
                    {formData.vestingEvents.map((event, index) => (
                        <Paper key={index} elevation={0} sx={{p:2, mb:1.5, border: '1px solid #e0e0e0', borderRadius: '8px'}}>
                            <Grid container spacing={2} alignItems="center">
                                <Grid size={{ xs: 12, sm: 4 }}><TextField name="vestDate" label="Vest Date" type="date" value={event.vestDate} onChange={e => handleEventChange(index, e)} InputLabelProps={{ shrink: true }} fullWidth/></Grid>
                                <Grid size={{ xs: 12, sm: 3 }}><TextField name="optionsVested" label="Options Vested" type="number" value={event.optionsVested} onChange={e => handleEventChange(index, e)} fullWidth/></Grid>
                                <Grid size={{ xs: 12, sm: 3 }}><FormControlLabel control={<TextField type="checkbox" name="isCliff" checked={event.isCliff} onChange={e => handleEventChange(index, e)} />} label="Is Cliff?" size="small" /></Grid>
                                ...
                                <Grid size={{ xs: 12 }}><TextField name="notes" label="Event Notes" value={event.notes} onChange={e => handleEventChange(index, e)} fullWidth size="small"/></Grid>
                            </Grid>
                        </Paper>
                    ))}
